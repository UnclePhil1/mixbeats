...
const Introduction = () => {
  return (
    <div className='w-full p-20 bg-blue-500 flex justify-center items-start flex-col'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 my-8 gap-5'>
            <button><Link href="/signup" className='py-4 px-6 rounded-full font-semibold text-white bg-dark hover:text-gray hidden md:block'>Get Started</Link></button>
